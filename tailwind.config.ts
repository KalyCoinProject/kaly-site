  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        kaly: {
          amber: "#F59E0B", // KalyChain amber color
          gold: "#F7931A", // Bitcoin-like gold
          dark: "#0F172A", // Dark blue for backgrounds
          light: "#F8FAFC", // Light color for text on dark backgrounds
          blue: {
